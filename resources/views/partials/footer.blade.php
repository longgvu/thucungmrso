...
<div class="footer container-fluid justify-content-center d-flex align-items-center p-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="col-md-8">
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item tel"><i class="fas fa-phone"></i>Điện thoại: 0909 179 979-028 896 1777
                        </li>
                        <li class="list-inline-item"><i class="fas fa-envelope"></i>Email:gianghiepan27051992@gmail.com</a>
                        </li>
            ...
            <div class="col-md-3 justify-content-center">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-3"><img src="{{URL::asset('images/phone.png')}}" class="w-100" alt="Phone"></div>
                        <div class="col p-2">
                    ...
                    <ul class="list-inline">
                        <div class="row">
                            ...
                            <li class="list-inline-item col-2 p-0"><a href="https://www.facebook.com/example"><img
                                        src="{{URL::asset('images/mastercard.png')}}" alt="Mastercard"></a></li>
                            <li class="list-inline-item col-2 p-0"><a href="https://plus.google.com/example"><img
                                        src="{{URL::asset('images/visaa.png')}}" alt="ViSA"></a></li>
                            <li class="list-inline-item col-2 p-0"><a href="https://zalo.me/example"><img
                                        src="{{URL::asset('images/jcb.jpg')}}" alt="JCB"></a></li>
                        </div>
                    </ul>
                </div>
            </div>
    ...
    <div class="vcard d-none">
        <span class="fn org">thú cung mr sọ</span> <!-- Tên cửa hàng -->
        <div class="adr"> <!-- Địa chỉ -->
            <span class="street-address">685 nguyễn xiển,
                long thạnh mỹ, quận 9, ho chi minh</span>
            <span class="locality">hồ chí minh</span>
            <span class="region">hồ chí minh</span>
            <span class="postal-code">70000</span>
            <span class="country-name">việt nam</span>
        </div>
        <span class="tel">0909 179 979-028 896 1777</span> <!-- Số điện thoại -->
        <span class="email">gianghiepan27051992@gmail.com</span> <!-- Địa chỉ Email -->
        <a class="url" href="https://thucungmrso.com">http://thucungmrso.com</a> <!-- Website -->
    </div>
...
<script>
  var swiper = new Swiper('.swiper-container-user', {
    slidesPerView: 3,
  slidesPerGroup: 1,
    spaceBetween: 10,
    speed:1000,
...
<script>
    var swiper = new Swiper('.swiper-container-product', {
      ...
      speed: 3000,
      autoplay: {
            delay: 0, // Delay between transitions in milliseconds (5 seconds in this example)
            disableOnInteraction: false, // Enable autoplay even if the user interacts with the swiper
        },
      breakpoints: {
   ...
   <script>
      ...
      if (screenWidth <= 576) {
        $('section').removeClass('p-5').addClass('p-1');
      } else {
        $('section').removeClass('p-1');
      }
    });

    // Trigger sự kiện resize khi tải trang
